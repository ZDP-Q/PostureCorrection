...
class MediaPipeFullDetector(BaseDetector):
    """
    MediaPipe Full 姿态检测器
    
    使用完整版模型，比 Lite 版本更准确，但速度稍慢
    适合对精度要求较高的场景
    """
    ...
    def description(self) -> str:
        return "MediaPipe Full 姿态检测器 - 完整版模型，精度更高"
    ...
    def _ensure_model_downloaded(self) -> None:
        ...
        if not os.path.exists(self._model_path):
            print(f"正在下载 MediaPipe Full 姿态模型到 {self._model_path}...")
